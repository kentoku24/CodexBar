...
protocol LocalFileSnapshotRefreshing: Sendable {
...
struct LocalFileSnapshotRefresher: LocalFileSnapshotRefreshing {
        ...
        environment: [String: String]) async throws
    {
        ...
        do {
            _ = try await SubprocessRunner.run(
                ...
                label: "local-file-refresh-\(provider.rawValue)")
        } catch {
            self.logger.warning(
                "Local File snapshot refresh failed",
                metadata: [
